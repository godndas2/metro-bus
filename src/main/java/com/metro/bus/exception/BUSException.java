package com.metro.bus.exception;

import com.metro.bus.config.PropertiesConfig;
...
public class BUSException {
    ...
    @Autowired
    public BUSException(PropertiesConfig propertiesConfig) {
        BUSException.propertiesConfig = propertiesConfig;
    }
